...
function RouteComponent() {
    ...
    return (
        <div className="h-dvh p-[10px] overflow-hidden box-border flex flex-col gap-[10px]">
            ...
            <div className="bg-secondary rounded-xl p-[10px] flex items-center justify-center h-full">
                <div className="max-w-sm w-full rounded-2xl border p-8 bg-card text-card-foreground shadow-sm">
                    <Outlet />
                </div>
            </div>
        </div>
