...
export default function EditRideForm({
    ...
    const form = useForm<RideFormValues>({
        ...
        defaultValues: {
            ...
            tripDuration: defaultValues.tripDuration ?? undefined,
            tripDistance: defaultValues.tripDistance ?? undefined,
            donationType: defaultValues.donationType ?? undefined,
            donationAmount: defaultValues.donationAmount ?? undefined,
    ...
    return (
        <Form {...form}>
            ...
            >
                ...
                {/* Destination Details */}
                <div className="md:col-span-2">
                    <h3 className="text-lg font-semibold mt-4">Destination Details</h3>
                </div>
