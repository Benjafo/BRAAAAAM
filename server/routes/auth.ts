...
import { signInSchema, requestPasswordResetSchema, createPasswordSchema } from '../schemas/authSchemas';
...
router.post('/request-password-reset', validateData(requestPasswordResetSchema), authController.requestPasswordReset);
